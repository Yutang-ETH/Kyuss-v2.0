...
circos.text(x = 0, y = mm_y(5), labels = 'A', sector.index = levels(mychrinfo$chr)[1], track.index = 1,
...
circos.track(sector = mychrinfo$chr, ylim = c(0, 100), cell.padding = c(0, 0, 0, 0), track.height = mm_h(10), bg.border = NA)
...
# add label
circos.text(x = 0, y = mm_y(12), labels = 'B', sector.index = levels(mychrinfo$chr)[1], track.index = 2,
            facing = "bending.inside", pos = 2, offset = 1.5, cex = 1)
...
circos.track(sector = mychrinfo$chr, ylim = c(0, 1), cell.padding = c(0, 0, 0, 0), track.height = mm_h(8), bg.border = NA)
...
# add label
circos.text(x = 0, y = mm_y(10), labels = 'C', sector.index = levels(mychrinfo$chr)[1], track.index = 3,
            facing = "bending.inside", pos = 2, offset = 1.5, cex = 1)
...
circos.track(sector = mychrinfo$chr, ylim = c(0, 1), cell.padding = c(0, 0, 0, 0), track.height = mm_h(5), bg.border = "gray80")
...
# add label
circos.text(x = 0, y = mm_y(7), labels = 'D', sector.index = levels(mychrinfo$chr)[1], track.index = 4,
            facing = "bending.inside", pos = 2, offset = 1.5, cex = 1)
...
circos.track(sector = mychrinfo$chr, ylim = c(0, 100), cell.padding = c(0, 0, 0, 0), track.height = mm_h(5), bg.border = 'gray80')
...
# add lable
circos.text(x = 0, y = mm_y(7), labels = 'E', sector.index = levels(mychrinfo$chr)[1], track.index = 5,
            facing = "bending.inside", pos = 2, offset = 1.5, cex = 1)
